System.register(['angular2/core', '../services/photo.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            PhotoRow = (function () {
                function PhotoRow(_photoService) {
                    var _this = this;
                    _photoService.getPhotosPromise().then(function (photos) { return _this.photoList = photos; });
                }
                PhotoRow.prototype.ngOnInit = function () {
                    this.photoListSorted = this.photoList.sort(function (a, b) { return b.likes - a.likes; });
                    this.photoListRanked = [];
                    for (var index in this.photoListSorted) {
                        if (Number(index) < 3) {
